...
w których nie pracowała osoba o nazwisko
@nazwisko nvarchar(100) - kolejny parametr

Wykonać testy i uzasadnic poprawność
*/
...
--Sprawdzam w jakich województwach znajdują się firmy osób na dane nazwisko
/*
...
--dodaję kolumnę ulica w tabeli osoby:
/*
...
BEGIN
	...
	--przyjmuję że id_osoby nie będzie dłuższe niż 2 cyfry
...
/*
Z 6.3
wykorzystać obie funkcje w procedure pokazującej dane osobowe
...
AS
SELECT dbo.WypiszDane(o.id_osoby, o.IMIĘ, o.NAZWISKO) as Dane, dbo.WypiszAdres(w.nazwa, m.nazwa, o.ULICA) as Adres
	FROM osoby o
...
ID: 6 OS:M. Kamińska           W:MAZOWIECKIE; M:Siedlce; UL:Pl. Politechniki
